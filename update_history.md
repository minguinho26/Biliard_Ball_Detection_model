...
**22.02.15** : 학습을 하기 전에 데이터셋을 '객체 탐지하기 쉬운 이미지'와 '객체 탐지하기 어려운 이미지'로 나눠서 생성 후 150 에포크는 쉬운 이미지 학습을 하고 이후 150 에포크를 어려운 이미지 학습을 하게끔 만들었습니다. 현재 epoch 222에서 측정된 학습성능은 다음과 같습니다.