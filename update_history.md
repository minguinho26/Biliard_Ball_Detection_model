...
**22.02.15** : 학습을 하기 전에 데이터셋을 '객체 탐지하기 쉬운 이미지'와 '객체 탐지하기 어려운 이미지'로 나눠서 생성 후 150 에포크는 쉬운 이미지 학습을 하고 이후 150 에포크를 어려운 이미지 학습을 하게끔 만들었습니다. 현재 epoch 224에서 측정된 학습성능은 다음과 같습니다.

| Type        | Value               |
|-------------|---------------------|
| IoU loss    | 0.21910129487514496 |
| Object loss | 0.04108991101384163 |
| Class loss  | 0.3355417251586914  |
| Batch loss  | 0.5957329273223877  |

| Index | Class              | AP      |
|-------|--------------------|---------|
| 0     | biliard_stick      | 0.26929 |
| 1     | hand               | 0.70077 |
| 2     | two_balls          | 0.38657 |
| 3     | three_balls        | 0.00000 |
| 4     | red_ball           | 0.96194 |
| 5     | white_ball         | 0.89232 |
| 6     | yellow_ball        | 1.06550 |
| 7     | moving_red_ball    | 0.56489 |
| 8     | moving_white_ball  | 0.52101 |
| 9     | moving_yellow_ball | 0.63885 |

---- mAP 0.59581 ----

| Type                 | Value    |
|----------------------|----------|
| validation precision | 0.505838 |
| validation recall    | 0.712507 |
| validation mAP       | 0.600113 |
| validation f1        | 0.565802 |
